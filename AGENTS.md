...
This repository is the TalentPilot recruiting intelligence assistant for the Computing Power Business Unit. The product requirements live in [PRD.md](PRD.md). The current work phase is post-E8 quality hardening, after the E8 Custom Role Management implementation on top of the implemented IAM, E2, E3, E4, E5, E6, and E7 foundations.
...
- E8 Custom Role Management SPEC: [docs/specs/008-custom-role-management.md](docs/specs/008-custom-role-management.md)
- E8 implementation plan: [docs/superpowers/plans/2026-07-12-e8-custom-role-management-implementation.md](docs/superpowers/plans/2026-07-12-e8-custom-role-management-implementation.md)
...
- Quality Hardening SPEC: [docs/specs/010-quality-hardening.md](docs/specs/010-quality-hardening.md)
- Quality Hardening implementation plan: [docs/superpowers/plans/2026-07-12-quality-hardening-implementation.md](docs/superpowers/plans/2026-07-12-quality-hardening-implementation.md)
