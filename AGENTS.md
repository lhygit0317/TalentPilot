...
This repository is the TalentPilot recruiting intelligence assistant for the Computing Power Business Unit. The product requirements live in [PRD.md](PRD.md). The current work phase is E3 Resume Recommendation implementation, building on the implemented E2 shared matching boundary.
