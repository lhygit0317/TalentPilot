...
This repository is the TalentPilot recruiting intelligence assistant for the Computing Power Business Unit. The product requirements live in [PRD.md](PRD.md). The current work phase is post-E8 planning, after the E8 Custom Role Management implementation on top of the implemented IAM, E2, E3, E4, E5, E6, and E7 foundations.
