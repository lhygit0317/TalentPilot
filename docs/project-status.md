...
| E8 | Custom role management | In Progress | `docs/specs/008-custom-role-management.md` and `docs/superpowers/plans/2026-07-12-e8-custom-role-management-implementation.md` planned: aggregated RoleAdmin API, complete IAM whitelist permission matrix, role CRUD, enable/disable, RoleRelation cycle/depth validation, reference-count delete protection, audit/cache invalidation, and frontend role management page. | Implement E8 using the approved plan. |

## Current Recommended Order

1. Implement E8 custom role management.
2. Keep future notification expansion after E8 unless product priority changes.
