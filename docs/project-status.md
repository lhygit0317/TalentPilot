...
1. Plan E2 Resume Parsing in `docs/specs/005-resume-parse-workspace.md`, using E4 resumes and E5 position data as dependencies.
2. Plan E3 after E2 defines parsing output and matching handoff.
