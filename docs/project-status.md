...
| E3 | Resume recommendation and routing | In Progress | `docs/specs/006-resume-recommendation-notification.md` drafted and `docs/superpowers/plans/2026-07-12-e3-resume-recommendation-implementation.md` created for Story 3.1-3.3: intelligent routing, recommendation deduplication, `PositionResume(kind=recommended)`, and notification record creation. E7 notification center UI remains out of scope. E2 shared matching boundary is now available. | Implement with TDD. |
...
1. Implement E3 from `docs/superpowers/plans/2026-07-12-e3-resume-recommendation-implementation.md`.
