...
| E3 | Resume recommendation and routing | In Progress | `docs/specs/006-resume-recommendation-notification.md` drafted for Story 3.1-3.3: intelligent routing, recommendation deduplication, `PositionResume(kind=recommended)`, and notification record creation. E7 notification center UI remains out of scope. | Review and approve SPEC, then create implementation plan. |
...
2. Review and approve `docs/specs/006-resume-recommendation-notification.md`, then create the E3 implementation plan.
