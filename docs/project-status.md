...
| E7 | Notifications | In Progress | E3-created notification records are implemented; E7 behavior is specified in `docs/specs/009-notification-center.md`, and implementation is planned in `docs/superpowers/plans/2026-07-12-e7-notification-center-implementation.md`: unread count, bell dropdown, mark-all-read, click-through to resume library, and notification permission seed adjustment for manager/trainee recipients. | Implement with TDD from the E7 plan. |
| E8 | Custom role management | Not Started | IAM model, permissions, RoleRelation validation | `008-custom-role-management.md` |

## Current Recommended Order

1. Implement E7 notification center behavior from the approved SPEC and implementation plan.
2. Keep E8 custom role management after E7 unless product priority changes.
