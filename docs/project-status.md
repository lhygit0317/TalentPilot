...
| E7 | Notifications | In Progress | E3-created notification records are implemented; E7 behavior is specified in `docs/specs/009-notification-center.md`: unread count, bell dropdown, mark-all-read, click-through to resume library, and notification permission seed adjustment for manager/trainee recipients. | Review SPEC, then write the implementation plan. |
| E8 | Custom role management | Not Started | IAM model, permissions, RoleRelation validation | `008-custom-role-management.md` |

## Current Recommended Order

1. Review the E7 notification center SPEC and write the implementation plan after approval.
