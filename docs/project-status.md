...
| E8 | Custom role management | Not Started | IAM model, permissions, RoleRelation validation | Plan `008-custom-role-management.md`. |

## Current Recommended Order

1. Plan E8 custom role management.
