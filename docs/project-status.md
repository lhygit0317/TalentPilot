...
| E6 | User and role management | In Progress | `docs/specs/007-user-role-management.md` and `docs/superpowers/plans/2026-07-12-e6-user-role-management-implementation.md` drafted for PRD Story 6.1-6.4: user list, visible `UserDepartmentRole` bindings, assignment, batch assignment, removal, duplicate prevention, guest fallback, audit, and cache invalidation. Role definition editing is explicitly deferred to E8. | Implement with TDD. |
| E7 | Notifications | Not Started | E3-created notification records are implemented; notification center APIs/UI are future work. | Future `docs/specs/009-notification-center.md`. |
| E8 | Custom role management | Not Started | IAM model, permissions, RoleRelation validation | `008-custom-role-management.md` |

## Current Recommended Order

1. Implement E6 from `docs/superpowers/plans/2026-07-12-e6-user-role-management-implementation.md`.
2. Keep E7 notification center planning after E6 unless product priority changes.
