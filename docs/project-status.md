...
| E6 | User and role management | In Progress | `docs/specs/007-user-role-management.md` drafted for PRD Story 6.1-6.4: user list, visible `UserDepartmentRole` bindings, assignment, batch assignment, removal, duplicate prevention, guest fallback, audit, and cache invalidation. Role definition editing is explicitly deferred to E8. | Review SPEC and write implementation plan. |
...
1. Review `docs/specs/007-user-role-management.md`, then write the E6 implementation plan.
