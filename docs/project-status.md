...
| E2 | Resume parsing | In Progress | `docs/specs/005-resume-parse-workspace.md` drafted and `docs/superpowers/plans/2026-07-07-e2-resume-parse-workspace-implementation.md` created for full Story 2.1-2.5 delivery using synchronous backend matching plus deterministic interview-question generation. Depends on E4 resumes and E5 positions. | Implement with TDD; E3 depends on the shared matching boundary from this work. |
| E3 | Resume recommendation and routing | In Progress | `docs/specs/006-resume-recommendation-notification.md` drafted and `docs/superpowers/plans/2026-07-12-e3-resume-recommendation-implementation.md` created for Story 3.1-3.3: intelligent routing, recommendation deduplication, `PositionResume(kind=recommended)`, and notification record creation. E7 notification center UI remains out of scope. | Implement with TDD after the E2 shared matching boundary is available. |
...
| E7 | Notifications | Not Started | E3-created notification records and future notification service APIs | Future `docs/specs/009-notification-center.md` after E3 implementation. |
| E8 | Custom role management | Not Started | IAM model, permissions, RoleRelation validation | `008-custom-role-management.md` |

## Current Recommended Order

1. Implement E2 with TDD through the shared `matching` boundary required by E3.
2. Implement E3 from `docs/superpowers/plans/2026-07-12-e3-resume-recommendation-implementation.md` after the E2 shared matching boundary is available.
