...
export interface paths {
    ...
    "/notifications/read-all": {
        ...
        post: operations["post-notifications-read-all"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/notifications/summary": {
        ...
        get: operations["get-notifications-summary"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/notifications/{notificationId}/read": {
        ...
        get?: never;
        put?: never;
        /** Mark a current-user notification read */
        post: operations["post-notification-read"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/roles/permission-options": {
        ...
        get: operations["get-role-permission-options"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/roles/{roleId}": {
        ...
        patch: operations["patch-role"];
        trace?: never;
    };
    "/roles/{roleId}/enabled": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        options?: never;
        head?: never;
        /** Toggle role enabled state */
        patch: operations["patch-role-enabled"];
        trace?: never;
    };
    "/users": {
        parameters: {
...
export interface components {
    schemas: {
        ...
        NotificationItem: {
            ...
            /** Format: date-time */
            createdAt: string;
            department: components["schemas"]["NotificationDepartmentSummary"];
            id: string;
            position?: components["schemas"]["NotificationPositionSummary"];
            read: boolean;
            recommender: components["schemas"]["NotificationUserSummary"];
            resumeId: string;
        };
        ...
        NotificationMarkReadResult: {
            notification: components["schemas"]["NotificationItem"];
            /** Format: int64 */
            unreadCount: number;
        };
        NotificationPositionSummary: {
            id: string;
            name: string;
        };
        ...
        PermissionActionOption: {
            action: string;
            supportsConditions: components["schemas"]["ConditionSupport"];
        };
        PermissionInput: {
            action: string;
            attributeConditions?: components["schemas"]["AttributeConditions"];
            resource: string;
        };
        PermissionOptionsResult: {
            conditionOptions: components["schemas"]["ConditionOptions"];
            resources: components["schemas"]["PermissionResourceOption"][];
        };
        PermissionResourceOption: {
            actions: components["schemas"]["PermissionActionOption"][];
            resource: string;
        };
        PositionBody: {
            /** @enum {string} */
...
export interface operations {
    ...
    "get-notifications-summary": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NotificationSummaryResult"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    "get-roles": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RoleListResult"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    "post-role": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RoleDefinitionInput"];
            };
        };
        responses: {
            /** @description OK */
    ...
    "get-role-permission-options": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PermissionOptionsResult"];
                };
            };
            /** @description Unauthorized */
            401: {
    ...
    "patch-role-enabled": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ToggleEnabledInput"];
            };
        };
        responses: {
            /** @description OK */
